...
export const EMAIL_ERROR_MSJ = 'Write a valid E-mail please';
export const NAME_ERROR_MSJ = 'Write a valid name please';
export const PASSWORD_ERROR_MSJ = 'Write a password whith 6 or more characters';
